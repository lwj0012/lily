...
public class searchDlg extends Activity implements OnClickListener {
	userinfo mUserinfo;
	@Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AutoCompleteTextView textView = (AutoCompleteTextView) findViewById(R.id.search_dlg_edit);
        textView.setAdapter(adapter);
        Button mButton = (Button)findViewById(R.id.search_dlg_go);
	...
	public void onClick(View v) {
		...
		Intent mIntent = new Intent(searchDlg.this, threadList.class);
